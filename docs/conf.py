...
# -*- coding: utf-8 -*-
#
# durga documentation build configuration file, created by
...
# built documents.
#
_version_py = os.path.join('..', 'durga', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'durga.tex', 'durga Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'durga', 'durga Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'durga', 'durga Documentation',
     author, 'durga', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    lib_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'durga'))
